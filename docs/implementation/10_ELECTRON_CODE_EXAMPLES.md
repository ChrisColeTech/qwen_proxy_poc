# Electron Code Examples

This document captures the current Electron application code verbatim, including configuration files and source code. No modifications have been made. The code is from the `electron/` directory.
