          ...
          <div className="guide-step-list">
            <div className="guide-step-item">
              ...
              <div className="guide-step-text">
                Click <span className="step-inline-code">Connect to Qwen</span> button on home page
              </div>
            </div>
            <div className="guide-step-item">
              <CheckCircle className="guide-step-icon" />
              <div className="guide-step-text">
                Follow installation link if extension not detected
              </div>
            </div>
            <div className="guide-step-item">
              <CheckCircle className="guide-step-icon" />
              <div className="guide-step-text">
                Install <span className="step-inline-code">Qwen Credential Extractor</span> from Chrome Web Store
              </div>
            </div>
          </div>
        </div>
